...
MISSING_EIDS  = [
    # Grupos A, B, C, D — primeros 8 F2 (re-scrape con código corregido)
    15186731,  # Czechia vs South Africa (A)
    15186806,  # Switzerland vs Bosnia & Herzegovina (B)
    15186798,  # Canada vs Qatar (B)
    15186490,  # Mexico vs South Korea (A)
    15186878,  # USA vs Australia (D)
    15186859,  # Scotland vs Morocco (C)
    15186856,  # Brazil vs Haiti (C)
    15186879,  # Türkiye vs Paraguay (D)
    # Grupos E, F (June 20-21)
    15186957,  # Netherlands vs Sweden (F)
    15186905,  # Germany vs Côte d'Ivoire (E)
    15186906,  # Ecuador vs Curaçao (E)
    15186963,  # Tunisia vs Japan (F)
    # Grupos G, H (June 21)
    15186840,  # Spain vs Saudi Arabia (H)
    15186499,  # Belgium vs Iran (G)
    15186800,  # Uruguay vs Cabo Verde (H)
    15186827,  # New Zealand vs Egypt (G)
